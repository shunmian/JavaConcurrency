...
public class BoundedBufferTest {
  ...
  public void testIsEmptyWhenConstructed() {
    SemaphoreBoundedBuffer<Integer> boundedBuffer = new SemaphoreBoundedBuffer<Integer>(10);
  ...
  public void testTakeBlocksWhenEmpty() {
    final SemaphoreBoundedBuffer<Integer> boundedBuffer = new SemaphoreBoundedBuffer<Integer>(10);
